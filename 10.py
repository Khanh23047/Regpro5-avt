...
\033[1;97m= = = = = = = = = = = = = = = = = = = = = = = = = = = = = """ 
    ...
    def ndp_delay_tool(self, p):
        ...
        while(p>1):
            p=p-1
            print(f'[ 🌸DUYKHANH🌸][|][LO......][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸DUYKHANH🌸][/][LOA.....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸DUYKHANH🌸][-][LOAD....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸DUYKHANH🌸][+][LOADI...][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸DUYKHANH🌸][\][LOADIN..][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸DUYKHANH🌸][|][LOADING.][{p}]','     ',end='\r');sleep(1/6)
